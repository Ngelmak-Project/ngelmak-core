...
public class TicketResource {
    ...
    private record TicketResolveDTO(Long id) {
    }

    /**
     * {@code POST  /tickets/resolve} : resolve the ticket which ID is provided in
     ...
     */
    @PostMapping("/resolve")
    public ResponseEntity<Ticket> getTicket(@RequestBody TicketResolveDTO ticketResolveDTO) {
        log.debug("REST request to get Ticket : {}", ticketResolveDTO);
        Optional<Ticket> ticket = ticketService.resolve(ticketResolveDTO.id);
